...
SAMPLE_SIGNALS: list[dict] = [
    ...
    {"c": "Middlesbrough", "r": "North East", "lat": 54.57, "lng": -1.23,
     "f": "poverty", "p": "47% of children in poverty",
     "s": "End Child Poverty ranks Middlesbrough worst in England for child poverty (~47%).",
     "sev": 84, "src": "End Child Poverty"},
    {"c": "England (national)", "r": "England", "lat": 52.3555, "lng": -1.1743,
